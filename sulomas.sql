...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2021 at 08:34 AM
...
(1, 'eee', '222', 'test@test.com'),
(2, 'Madiha', '111222', 'madiha@test.com'),
(3, 'mable', '111', 'mable@outlook.com'),
(4, 'kevinchang', '202cb962ac59075b964b07152d234b70', 'kevin@istvari.com'),
(5, 'Test', '698d51a19d8a121ce581499d7b701668', 'ggg@outlook.com'),
(6, 'guest', '81dc9bdb52d04dc20036dbd8313ed055', 'gyuest@gg.com'),
(7, 'Diha', '7e0deb8853363a84629ba98fbaa29c55', 'sales@sulomas.com.my');
...
INSERT INTO `bincollection` (`ID`, `ACC_ID`, `BIN_CODE`, `Address`, `DATETIME`, `Status`, `Latitude`, `Longtitude`) VALUES
(1, 4, 'ISTVARI00001', 'Sulomas Sdn Bhd, Jalan Permata 1, Kawasan Perindustrian Nilai, Nilai, Negeri Sembilan, Malaysia', '2021-12-15 09:07:32', 'Collected', 2.861238, 101.815895),
(2, 4, 'ISTVARI00002', 'Pharmafood Engineering Sdn Bhd, Jalan Permata 1/6, Arab Malaysian Industrial Park, Nilai, Negeri Sembilan, Malaysia', '2021-12-15 09:07:38', 'Collected', 2.863431, 101.802856),
(3, 4, 'ISTVARI00003', 'Restoran Satay Poh G, Jalan Permata, Arab Malaysian Industrial Park, Nilai, Negeri Sembilan, Malaysia', '2021-12-15 09:07:44', 'Collected', 2.866362, 101.799461),
(4, 4, 'ISTVARI00004', 'Meditech Gloves Sdn. Bhd., Jalan Permata 1/3, Arab Malaysian Industrial Park, Nilai, Negeri Sembilan, Malaysia', '2021-12-15 09:07:51', 'Collected', 2.863665, 101.810265),
(5, 4, 'ISTVARI00005', 'IGC Industrial Galv Corporation. Sdn. Bhd., Lorong Am 11, Arab Malaysian Industrial Park, Nilai, Negeri Sembilan, Malaysia', '2021-12-15 09:07:58', 'Collected', 2.864756, 101.807312),
(6, 4, 'ISTVARI00006', 'Kian Joo Canpack Sdn. Bhd., Arab Malaysian Industrial Park, Nilai, Negeri Sembilan, Malaysia', '2021-12-15 09:08:08', 'Collected', 2.860462, 101.806145);
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `update_status` ON SCHEDULE EVERY 1 DAY STARTS '2021-12-16 00:00:00' ON COMPLETION PRESERVE ENABLE DO UPDATE bincollection SET Status = ('Not Collected')$$
